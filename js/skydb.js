...
var conname = [
    ...
    { pos: { ra: 0.69, dec: 0.364 }, abbrev: 'Ari', name: 'Aries' },
    ...
    { pos: { ra: 1.97, dec: 0.113 }, abbrev: 'CMi', name: 'Canis Minor' },
    { pos: { ra: 3.433, dec: 0.7 }, abbrev: 'CVn', name: 'Canes Venatici' },
    ...
    { pos: { ra: 1.9, dec: -1.0 }, abbrev: 'Car', name: 'Carina' },
    { pos: { ra: 0.15, dec: 1.086 }, abbrev: 'Cas', name: 'Cassiopeia' },
    { pos: { ra: 3.424, dec: -0.828 }, abbrev: 'Cen', name: 'Centaurus' },
    { pos: { ra: 5.89, dec: 1.24 }, abbrev: 'Cep', name: 'Cepheus' },
    { pos: { ra: 0.4, dec: -0.224 }, abbrev: 'Cet', name: 'Cetus' },
    { pos: { ra: 2.799, dec: -1.386 }, abbrev: 'Cha', name: 'Chamaeleon' },
    { pos: { ra: 3.817, dec: -1.1 }, abbrev: 'Cir', name: 'Circinus' },
    { pos: { ra: 2.264, dec: 0.39 }, abbrev: 'Cnc', name: 'Cancer' },
    { pos: { ra: 1.536, dec: -0.613 }, abbrev: 'Col', name: 'Columba' },
    { pos: { ra: 3.38, dec: 0.465 }, abbrev: 'Com', name: 'Coma Berenices' },
    {
        pos: { ra: 4.882, dec: -0.718 },
        abbrev: 'CrA',
    ...
    { pos: { ra: 5.392, dec: 0.7 }, abbrev: 'Cyg', name: 'Cygnus' },
    ...
    { pos: { ra: 1.85, dec: 0.394 }, abbrev: 'Gem', name: 'Gemini' },
    { pos: { ra: 5.88, dec: -0.809 }, abbrev: 'Gru', name: 'Grus' },
    { pos: { ra: 4.553, dec: 0.482 }, abbrev: 'Her', name: 'Hercules' },
    { pos: { ra: 0.858, dec: -0.93 }, abbrev: 'Hor', name: 'Horologium' },
    { pos: { ra: 2.73, dec: -0.25 }, abbrev: 'Hya', name: 'Hydra' },
    { pos: { ra: 0.609, dec: -1.22 }, abbrev: 'Hyi', name: 'Hydrus' },
    { pos: { ra: 5.5, dec: -0.942 }, abbrev: 'Ind', name: 'Indus' },
    { pos: { ra: 2.682, dec: 0.561 }, abbrev: 'LMi', name: 'Leo Minor' },
    { pos: { ra: 5.88, dec: 0.803 }, abbrev: 'Lac', name: 'Lacerta' },
    ...
    { pos: { ra: 4.938, dec: 0.64 }, abbrev: 'Lyr', name: 'Lyra' },
    { pos: { ra: 1.435, dec: -1.351 }, abbrev: 'Men', name: 'Mensa' },
    { pos: { ra: 5.489, dec: -0.633 }, abbrev: 'Mic', name: 'Microscopium' },
    { pos: { ra: 1.85, dec: 0.006 }, abbrev: 'Mon', name: 'Monoceros' },
    { pos: { ra: 3.294, dec: -1.225 }, abbrev: 'Mus', name: 'Musca' },
    { pos: { ra: 4.16, dec: -0.897 }, abbrev: 'Nor', name: 'Norma' },
    { pos: { ra: 4.0, dec: -1.55 }, abbrev: 'Oct', name: 'Octans' },
    { pos: { ra: 4.471, dec: 0.084 }, abbrev: 'Oph', name: 'Ophiuchus' },
    { pos: { ra: 1.459, dec: 0.02 }, abbrev: 'Ori', name: 'Orion' },
    { pos: { ra: 5.136, dec: -1.147 }, abbrev: 'Pav', name: 'Pavo' },
    { pos: { ra: 6.1, dec: 0.342 }, abbrev: 'Peg', name: 'Pegasus' },
    { pos: { ra: 0.83, dec: 0.786 }, abbrev: 'Per', name: 'Perseus' },
    { pos: { ra: 0.114, dec: -0.847 }, abbrev: 'Phe', name: 'Phoenix' },
    { pos: { ra: 1.495, dec: -0.933 }, abbrev: 'Pic', name: 'Pictor' },
    {
        pos: { ra: 5.834, dec: -0.535 },
        abbrev: 'PsA',
        name: 'Piscis Austrinus'
    },
    { pos: { ra: 0.206, dec: 0.15 }, abbrev: 'Psc', name: 'Pisces' },
    ...
    { pos: { ra: 3.51, dec: -0.072 }, abbrev: 'Vir', name: 'Virgo' },
